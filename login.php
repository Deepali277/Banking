...
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-left shadowBlue" style="margin-left: 600px;margin-top:150px">
	<br><h4 class="text-center text-primary">Select Your Choice</h4>
